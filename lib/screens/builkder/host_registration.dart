...
import 'package:oyo/screens/host/hostreg_2.dart';
...
class builder_regisstration extends StatefulWidget {
  @override
  _builder_regisstrationState createState() => _builder_regisstrationState();
}

class _builder_regisstrationState extends State<builder_regisstration> {
  ...
  TextEditingController company_license   =TextEditingController();
  ...
  bool islogin=false;
  bool value=false;
  Future host_registrataion(String n ,String ad,String aphone ,String gname  ,String gphone  ,String rg ,String companyname,String companyaddress )
  async {
    ...
    request.fields.addAll({
      ...
      'company_license':companyaddress,
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              // ),
              SizedBox(height: 30,),
              Text('Builder Registration ',style: TextStyle(
                ...
                child:  Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      ),), Text(' Becoming an builder',style: TextStyle(
                          color: Colors.black,fontWeight: FontWeight.normal,fontSize: 18
                      ),),
                    ],
                  ),
              ...
              SizedBox(height: height/40,),SizedBox(height: height/40,),
              Padding(
                padding: const EdgeInsets.only(left: 18.0,right: 18),
                child: Container(
                  height: height/15,
                  ...
                  child: TextFormField(                    validator: (v)=>v!.isEmpty?"Field can't be empty":null,
                    controller: company_license,
                    decoration: InputDecoration(
                        border: InputBorder.none,
                        hintText: "Company License ",
                        prefixIcon: Icon(Icons.receipt_long_outlined,color: Colors.grey,)
                    ),
                  ),
                ),
                ...
                child: InkWell(
                  onTap: (){
                    if(_formKey.currentState!.validate())  {
                      ...
                      host_registrataion(nid.text,address.text,alt_phone_number.text,guarantor_name.text,guarantor_phone_number.text,relation_with_guarantor.text,company_name.text,company_license.text);
                    }                },
                  child: Container(
                    height: height/15,
                    width: width,
