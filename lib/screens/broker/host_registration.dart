...
class broker_registration extends StatefulWidget {
  @override
  _broker_registrationState createState() => _broker_registrationState();
}

class _broker_registrationState extends State<broker_registration> {
              ...
              Text('Broker Registration ',style: TextStyle(
                ...
                child: Column(
                  children: [
                    ...
                    ),), Text(' Becoming an broker',style: TextStyle(
                        color: Colors.black,fontWeight: FontWeight.normal,fontSize: 18
                    ),),
                  ],
                ),
